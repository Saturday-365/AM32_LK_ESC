...
<i><b>2026.3.28 | 1、经过学习评估，fork一个AM32进行工程移植<br>2、完成工程移植 成功在此工程中点灯<br>发现LKS有HAL库，重新导入HAL库，着手研究AM32移植需要修改的文件

疑惑|其他   
----|---- 
<i><b>移植的方法即通过在AM32仓库中添加对LKS芯片的支持，与移植AM32核心的算法到LKS的工程中，二者的区别和主要优缺点 | 
<i><b>目前对于相关操作函数的移植毫无头绪，有些乱，晚上思考一下阅读仓库文件后再做下一步打算 | 
