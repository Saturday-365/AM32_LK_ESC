...
typedef struct
{
    ...
    __IO u32 null;       // 0x8c
    __IO u32 CLK_DIV0;   // 0x90 I2C clock div
    __IO u32 CLK_DIV1;   // 0x94 保留
...
#define SYS_MCU_POWER_3v3     1 // MCU 3.3V供电
#define SYS_MCU_POWER_5v0     0 // MCU 5V供电

// 在没有全局配置POWER_MODE时，使用5V供电作为默认参数
#ifndef POWER_MODE
#define POWER_MODE SYS_MCU_POWER_5v0
#endif

#define SYS_POWER_4V0  0x00 /*电源掉电监测阈值为4.0V*/
#define SYS_POWER_3V75 0x01 /*电源掉电监测阈值为3.75V*/
#define SYS_POWER_3V5  0x02 /*电源掉电监测阈值为3.5V*/
#define SYS_POWER_3V25 0x03 /* 仅在芯片版本0123时有效 电源掉电监测阈值为3.25V*/
#define SYS_POWER_2V5  0x03 /* 仅在芯片版本>=4时有效 电源掉电监测阈值为2.5V*/

// 兼容之前的写法
#ifndef MCU_POWER_3v3
#define MCU_POWER_3v3 SYS_MCU_POWER_3v3 // MCU 3.3V供电
#endif

#ifndef MCU_POWER_5v0
#define MCU_POWER_5v0 SYS_MCU_POWER_5v0 // MCU 5V供电
#endif

#ifndef POWER_4V0
#define POWER_4V0 SYS_POWER_4V0 /*电源掉电监测阈值为4.0V*/
#endif

#ifndef POWER_3V75
#define POWER_3V75 SYS_POWER_3V75 /*电源掉电监测阈值为3.75V*/
#endif

#ifndef POWER_3V5
#define POWER_3V5 SYS_POWER_3V5 /*电源掉电监测阈值为3.5V*/
#endif

#ifndef POWER_3V25
#define POWER_3V25 SYS_POWER_3V25 /* 仅在芯片版本0123时有效 电源掉电监测阈值为3.25V*/
#endif

#ifndef POWER_2V5
#define POWER_2V5 SYS_POWER_2V5 /* 仅在芯片版本>=4时有效 电源掉电监测阈值为2.5V*/
#endif
...
#define SECOND2IWDGCNT(x) ((u32)(32000 * (float)x + 0x800) & 0x1ff000) /**<看门狗时间计算*/
