...
void TIM_TimerInit(TIM_TimerTypeDef *TIMERx, TIM_TimerInitTypeDef *this)
{
    ...
    TIMERx->IO = this->Timer0_CH1_DEFAULT << 9 | this->Timer0_CH0_DEFAULT << 8 | this->Timer0_HALT_PRT << 7 | this->Timer0_FAIL_SEL << 2 | this->Timer0_FAIL_POL << 1 | this->Timer0_FAIL_EN;

    TIMERx->CFG = (u32)(this->Timer_CAP1_CLR_EN << 29) | (u32)(this->Timer_CAP0_CLR_EN << 28) | (u32)(this->Timer0_UPDATE << 27) | (u32)(this->Timer0_SHADOW << 26) | (u32)(this->Timer_ONE_TRIG << 25) | (u32)(this->Timer_CENTER << 24) | (u32)(this->Timer_DIR << 23) | (u32)(this->Timer_ClockDiv << 20) | (u32)(this->Timer_ETON << 19) | (u32)(this->Timer_GATE_EN << 18) | (u32)(this->Timer_RL_EN << 17) | (u32)(this->Timer_XCLK_EN << 16) | (u32)(this->Timer_SRC1 << 12) | (u32)(this->Timer_CH1Output << 11) | (u32)(this->Timer_CH1_WorkMode << 10) | (u32)(this->Timer_CH1_FE_CAP_EN << 9) | (u32)(this->Timer_CH1_RE_CAP_EN << 8) | (u32)(this->Timer_SRC0 << 4) | (u32)(this->Timer_CH0Output << 3) | (u32)(this->Timer_CH0_WorkMode << 2) | (u32)(this->Timer_CH0_FE_CAP_EN << 1) | (u32)(this->Timer_CH0_RE_CAP_EN);
...
{
    TIM_TimerCmd(UTIMERx, ENABLE);
}
void UTIMER_Disable(TIM_TimerTypeDef *UTIMERx)
{
    TIM_TimerCmd(UTIMERx, DISABLE);
}
